...
class SwarmControllerNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameters(
            ...
            parameters=[
                ...
                ('goal_factor', 0.01),
                ('damping_factor', 0.1),  # New parameter for damping
                ('min_speed', 0.01),
                ('max_speed', 0.2)
            ]
        )
    ...
    def calculate_and_publish_references(self):
        ...
        goal_factor = self.get_parameter('goal_factor').value
        damping_factor = self.get_parameter('damping_factor').value
        ...
        for boat in self.boats:
            ...
            damping_force = -damping_factor * velocity  # Damping force
            neighbor_count = 0
            ...
            desired_velocity = velocity + alignment_force + cohesion_force + separation_force + goal_force + damping_force
